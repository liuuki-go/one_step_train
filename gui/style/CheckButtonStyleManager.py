...
def _get_path(p):
    return get_resource_path(p).replace("\\", "/")
    ...
    _styles = {
        "primary": f"""
            ...
            QCheckBox::indicator {{
                ...
                border: none;             
                /* 新增：未选中状态的图标 */
                image: url({_get_path('gui/icon/action_model_icon/uncheck.png')}); 
            }}
            ...
            QCheckBox::indicator:checked {{
                ...
                image: url({_get_path('gui/icon/action_model_icon/checked.png')}); 
            }}
